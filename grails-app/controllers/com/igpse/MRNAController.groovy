...
class MRNAController {
    ...
    def save(MRNA MRNAInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'MRNAInstance.label', default: 'MRNA'), MRNAInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'MRNAInstance.label', default: 'MRNA'), params.id])
                redirect action: "index", method: "GET"
            }
